...
function init(){
    ...
    colorSet = [[[97,97,97],[65,65,65],[140,140,140,-30,-30,-30],[0,0,0]],
                ...
                [[45,63,64],[27,38,38],[28,35,64,-3,-5,-8],[8,3,25]],
    ...
    imgArbre = ["heart2-lvl","temple-lvl","arbrePierre","bambou","eraseMonsters","pont5","passerelle0","passerelle1","passerelle2","passerelle3","barriere0","barriere1","barriere2","palmiton","herbe0","herbe1","herbe2","rhizome0","rhizome1","rhizome2","rhizome3","rhizome4","rhizome5","rhizome6","rhizome7","rhizome8","rhizome9","rhizome10","bush0","house0","house1","house2","palmier","sword1","sword2","sword3","gear","special","lambda0","fastTravel","loot","outDoor","inDoor","monsters","fireTemple","sky","sky1","sky2","sky3","expand","rocher","shell","coffre0","coffre1","spe","save","delete","fill","pole","tele","eraseAll","GPS","switch0","switch1","wireGate0","wireGate1","wire0","wire1","porteTemple0","porteTemple1","porteTemple2","porteTemple1-2"];
    ...
    editArray = {"gear":["tele","eraseAll","eraseMonsters","GPS"],"switch1":["switch0","switch1","wireGate0","wireGate1","wire0","wire1"],"herbe0":["herbe0","herbe1","herbe2","palmier","rhizome0","arbrePierre","bambou"],"outDoor":["porteTemple0","porteTemple1","porteTemple2","pont3","pont4","pont5","passerelle0","passerelle1","passerelle2","passerelle3","barriere0","barriere1","barriere2","house0","house1","house2","lambda0","pole"],"inDoor":[],"monsters":["bokoblin","chuchu","moblin","feu","scie","ballon"],"fireTemple":[],"sky":["sky","sky1","sky2","sky3","delete","expand","fill"],"special":["tele","mark","coffre2","fastTravel"],"spe":["spe0","spe1","spe2","spe3","spe4","spe5","spe6","spe7","spe8","spe9"]};
...
function drawObj(x,y,z,obj,ctxa){
    ...
    if (obj[0] == "porteTemple0" || obj[0] == "porteTemple1" || obj[0] == "porteTemple2" || obj[0] == "pont3" || obj[0] == "pont4" || obj[0] == "pont5" || obj[0] == "rhizome0" || obj[0] == "rhizome1" || obj[0] == "rhizome2" || obj[0] == "rhizome3" || obj[0] == "rhizome4" || obj[0] == "rhizome5" || obj[0] == "rhizome6" || obj[0] == "rhizome7" || obj[0] == "rhizome8" || obj[0] == "rhizome9" || obj[0] == "rhizome10" || obj[0] == "herbe2" || obj[0] == "herbe1" || obj[0] == "herbe0" || obj[0] == "rocher" || obj[0] == "shell" || obj[0] == "switch1" || obj[0] == "switch0" || obj[0] == "wire0" || obj[0] == "wire1" || obj[0] == "wireGate0" || obj[0] == "wireGate1") Painter.img( ctxa, x+0.1, y + 0.5, z, imgElement[obj[0]] );
